class Type {
    ...
    User(params) {
        return new class User {
             ...
             * @param {boolean} user.is_bot - Whether the user is a bot.
             * @param {string} user.first_name - The user's first name.
             * @param {string} user.last_name - The user's last name.
             * @param {string} user.username - The user's username.
             * @param {string} user.language_code - The user's language code.
             * @param {boolean} user.is_premium - Whether the user is a premium user.
             * @param {boolean} user.added_to_attachment_menu - Whether the user has been added to the attachment menu.
             * @param {boolean} user.can_join_groups - Whether the user can join groups.
             * @param {boolean} user.can_read_all_group_messages - Whether the user can read all group messages.
             * @param {boolean} user.supports_inline_queries - Whether the user supports inline queries.
             *
             * @memberof User
             */
            constructor({
            ...
            /**
             * Gets whether the user is a premium user.
             * @readonly
             * @memberof User
             * @returns {boolean} Whether the user is a pemium user.
             */
